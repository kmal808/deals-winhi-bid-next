...
async function seed() {
  ...
  await db.insert(brands).values([
    { name: 'Alii', factor: '1.20', sortOrder: 1 },
    { name: 'Milgard', factor: '1.25', sortOrder: 2 },
    { name: 'Anlin', factor: '1.15', sortOrder: 3 },
    { name: 'PGT', factor: '1.20', sortOrder: 4 },
  ]).onConflictDoNothing()
  ...
  await db.insert(glassTypes).values([
    ...
    { name: 'Etch Matte', description: 'Etched matte finish', factor: '0.25', sortOrder: 2 },
    { name: 'Low-E', description: 'Low emissivity coating', factor: '0.15', sortOrder: 3 },
    { name: 'Tinted', description: 'Grey/Bronze tint', factor: '0.10', sortOrder: 4 },
    { name: 'Obscure', description: 'Privacy glass', factor: '0.20', sortOrder: 5 },
  ]).onConflictDoNothing()
  ...
  await db.insert(productConfigs).values([
    { name: 'XO', category: 'window', operationType: 'XO', liteCount: 2, imagePath: '/images/configs/slider-xo.png', sortOrder: 1 },
    { name: 'OX', category: 'window', operationType: 'OX', liteCount: 2, imagePath: '/images/configs/slider-ox.png', sortOrder: 2 },
    { name: 'XOX', category: 'window', operationType: 'XOX', liteCount: 3, imagePath: '/images/configs/slider-xox.png', sortOrder: 3 },
    { name: 'Single Hung', category: 'window', operationType: 'SH', liteCount: 1, imagePath: '/images/configs/single-hung.png', sortOrder: 4 },
    { name: 'Double Hung', category: 'window', operationType: 'DH', liteCount: 1, imagePath: '/images/configs/double-hung.png', sortOrder: 5 },
